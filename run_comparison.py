...
gt1 = scenario1_ground_truth("verification/data/scenario1_conversion.csv")
...
gt2 = scenario2_ground_truth("verification/data/scenario2_revenue.csv")
...
gt3 = scenario3_ground_truth("verification/data/scenario3_ctr.csv")
